	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<s:form action="saveEmployee" method="post">
				...
				<s:select name="employee.department.departmentId" value="%{employee.department.departmentId}" list="departments" label="%{getText('label.department')}" listKey="departmentId" listValue="name" cssClass="mt10 form-control"/>
